...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> fetchStats() async {
    try {
      final url = Uri.parse('http://192.168.54.252:5274/api/dashboard/stats');
  ...
  Future<void> fetchOrders() async {
    final url = Uri.parse('http://192.168.54.252:5274/api/orders/full');
    final response = await http.get(url);
    if (response.statusCode == 200) {
        ...
        child: isLoading
            ...
            : Column(
                ...
                children: [
                  ...
                  buildStatCard("Clients", "$nbClients clients", Icons.people, Colors.blue),
